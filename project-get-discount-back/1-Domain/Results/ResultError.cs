...
namespace project_get_discount_back.Results
{
    ...
    public struct ResultError
    {
        ...
        public static ResultError DeviceEmpty => new("Dispositivo vazio.", "U008");
        public static ResultError RegisterNameEmpty => new("Nome obrigatório.", "R001");
        public static ResultError RegisterLastNameEmpty => new("Nome obrigatório.", "R002");
        public static ResultError RegisterEmailEmpty => new("Email obrigatório.", "R003");
        public static ResultError RegisterRoleInvalido => new("Tipo de acesso Invalido.", "R004");
        public static ResultError AlreadyRegisteredUser => new("Usuário já cadastrado.", "R005");
        public static ResultError ErrorWhenSendingEmail => new ("Erro ao enviar o email.", "R006");
        ...
        public static ResultError RefreshTokenEmpty => new("Refresh Token vazio.", "R001");
